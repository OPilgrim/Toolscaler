# 测评 NDCG，代码来自 /data/suyunyue/Projects/tool/ToolGen/evaluation/retrieval/eval_toolgen.py
...
# @click.option('--corpus', type=str, help="In-domain or multi-domain.")
def main(
    model_name_or_path="models/numeric_ret_subset_10",   # Hierarchical, Numeric, Semantic
    indexing="Numeric",   # Atomic, Hierarchical, Numeric, Semantic
    stage="G1",  # G1, G2, G3
